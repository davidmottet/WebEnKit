var R4 = (function (window, document, undefined) {
  'use strict';
  ...
  //*** FUNCTION ***\\
	// CLASS \\
  self.addClass = function (_c, _e) {
     _e.className = _e.className+' '+_c;
  }

  self.removeClass = function (_c, _e) {
    var r = RegExp(' '+_c,'g');
    _e.className = _e.className.replace(r,'');
  }

  self.hasClass = function (_c, _e) {
    var r = RegExp(_c,'g');
  	return r.test(_e.className);
  }

  self.toggleClass = function (_c, _e) {
    var t = this.hasClass(_c, _e) ? this.removeClass(_c, _e) : this.addClass(_c, _e);
  }

  //*** TEST ***\\
  // NAVIGATEUR \\
  tests['whatIsNavigator'] = function () {
  ...
  // MOBILE & TABLETTE \\
  tests['isMobileAndTablette'] = function () {
    var bool = false;
